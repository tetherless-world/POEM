			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 3.2395in"/>
						<col style="WIDTH: 7.3958in"/>
						<col style="WIDTH: 0.9375in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>ItemStemID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ItemStemLanguage</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>ItemStemConceptID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ItemStemFullText</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ItemStemAuthors</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="_x0032_1_ItemStems">
							<!-- Cache the current node incase the a field is formatted -->
							<xsl:value-of select="fx:CacheCurrentNode(.)"/>
							<tr>
								<td>
									<xsl:value-of select="ItemStemID"/>
								</td>
								<td>
									<xsl:value-of select="ItemStemLanguage"/>
								</td>
								<td>
									<xsl:value-of select="Respondent"/>
								</td>
								<td>
									<xsl:value-of select="ItemStemConceptID"/>
								</td>
								<td>
									<xsl:value-of select="ItemStemFullText"/>
								</td>
								<td>
									<xsl:value-of select="ItemStemAuthors"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
