			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 5.8055in"/>
						<col style="WIDTH: 2.9027in"/>
						<col style="WIDTH: 1.0833in"/>
						<col style="WIDTH: 1.2395in"/>
						<col style="WIDTH: 3.2777in"/>
						<col style="WIDTH: 2.2986in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
							...
							<td>
								<div align="center">
									<strong>UsedEntityID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>GenEntityID</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="_x0030_3_Activities">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="AssociatedAgent"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="UsedEntityID"/>
								</td>
								<td>
									<xsl:value-of select="GenEntityID"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
