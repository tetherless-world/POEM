	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>31_ResponseOptions</title>
				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>OptionConceptID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>OptionLanguage</strong>
								</div>
							</td>
							<td>
								<div align="center">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="_x0033_1_ResponseOptions">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="OptionConceptID"/>
								</td>
								<td>
									<xsl:value-of select="OptionLanguage"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('OptionText', '@', '', '', 8)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
