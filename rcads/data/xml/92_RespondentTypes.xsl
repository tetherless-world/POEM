	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>92_RespondentTypes</title>
				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>RespondentTypeID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>RespondentType</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="_x0039_2_RespondentTypes">
							<!-- Cache the current node incase the a field is formatted -->
							<xsl:value-of select="fx:CacheCurrentNode(.)"/>
							<tr>
								<td>
									<xsl:value-of select="RespondentTypeID"/>
								</td>
								<td>
									<xsl:value-of select="RespondentType"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
