			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 4.677in"/>
						<col style="WIDTH: 1.7812in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>EntityGroupMapID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>EntityGroupID</strong>
								</div>
							</td>
							<td>
								<div align="center">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="_x0030_5_EntityGroupMap">
							<!-- Cache the current node incase the a field is formatted -->
							<xsl:value-of select="fx:CacheCurrentNode(.)"/>
							<tr>
								<td>
									<xsl:value-of select="EntityGroupMapID"/>
								</td>
								<td>
									<xsl:value-of select="EntityGroupID"/>
								</td>
								<td>
