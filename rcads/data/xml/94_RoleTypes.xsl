			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 1.8541in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 6.4479in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
							...
							<td>
								<div align="center">
									<strong>RoleClass</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>RoleDefinition</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="_x0039_4_RoleTypes">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="RoleDefinition"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
