			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 2.1145in"/>
						<col style="WIDTH: 1.4479in"/>
						<col style="WIDTH: 0.9375in"/>
					</colgroup>
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>AmbiguousID</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="_x0038_0_Persons">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('AmbiguousID', 'Yes/No', '', '', 8)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
