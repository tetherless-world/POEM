			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 2.5833in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 11.1145in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>MethodTypeID</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>MethodClass</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>MethodDefinition</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="_x0039_3_MethodTypes">
							<!-- Cache the current node incase the a field is formatted -->
							<xsl:value-of select="fx:CacheCurrentNode(.)"/>
							<tr>
								<td>
									<xsl:value-of select="MethodTypeID"/>
								</td>
								<td>
									<xsl:value-of select="MethodName"/>
								</td>
								<td>
									<xsl:value-of select="MethodClass"/>
								</td>
								<td>
									<xsl:value-of select="MethodDefinition"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
