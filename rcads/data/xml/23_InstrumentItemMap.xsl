	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>23_InstrumentItemMap</title>
			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 1.4895in"/>
						<col style="WIDTH: 6.677in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>InstrumentItemID</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>ItemPosition</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ItemDisplayNumber</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="_x0032_3_InstrumentItemMap">
							<!-- Cache the current node incase the a field is formatted -->
							<xsl:value-of select="fx:CacheCurrentNode(.)"/>
							<tr>
								<td>
									<xsl:value-of select="InstrumentItemID"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="ItemDisplayNumber"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
