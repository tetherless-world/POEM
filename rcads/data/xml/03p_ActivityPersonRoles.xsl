	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>03p_ActivityPersonRoles</title>
			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 4.1597in"/>
						<col style="WIDTH: 1.8333in"/>
						<col style="WIDTH: 2.8125in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
					...
					<tbody id="CTRL2">
						<xsl:for-each select="_x0030_3p_ActivityPersonRoles">
