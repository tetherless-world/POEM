			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 1.6979in"/>
						<col style="WIDTH: 1.6666in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 2.4791in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
							...
							<td>
								<div align="center">
									<strong>InstrumentCollection</strong>
								</div>
							</td>
							<td>
								<div align="center">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="_x0031_0_Instruments">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="InstrumentCollection"/>
								</td>
								<td>
