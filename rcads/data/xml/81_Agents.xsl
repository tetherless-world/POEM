			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 2.2291in"/>
						<col style="WIDTH: 2.6875in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
							...
							<td>
								<div align="center">
									<strong>Associated DOI</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="_x0038_1_Agents">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="Associated_x0020_DOI"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
