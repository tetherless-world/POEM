			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 2.125in"/>
						<col style="WIDTH: 1.6666in"/>
						<col style="WIDTH: 1.625in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>CodebookID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>CodebookName</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>CodebookExperience</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>CodebookLanguage</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="_x0033_0_Codebooks">
							<!-- Cache the current node incase the a field is formatted -->
							<xsl:value-of select="fx:CacheCurrentNode(.)"/>
							<tr>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('CodebookID', 'General Number', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('CodebookName', '@', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="CodebookExperience"/>
								</td>
								<td>
									<xsl:value-of select="CodebookLanguage"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
