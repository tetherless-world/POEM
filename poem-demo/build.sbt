...
libraryDependencies += "org.webjars.npm" % "choices.js" % "11.2.3"
...
libraryDependencies += "com.fasterxml.jackson.module" %% "jackson-module-scala" % "2.22.0"
...
libraryDependencies += "com.openai" % "openai-java" % "4.39.1"
